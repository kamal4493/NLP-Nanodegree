...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for x in range(recur_layers):
        rnn = GRU(units,
                  ...
                  return_sequences=True,
                  implementation=2,
                  name="simp_rnn_"+str(x+1))(last_layer)
        bn_rnn = BatchNormalization(name="bn_rnn_"+str(x+1))(rnn)
        last_layer = bn_rnn
...
def final_model(input_dim,
    ...
    bidir_rnn_1 = Bidirectional(GRU(units,
                                    ...
                                    return_sequences=True,
                                    implementation=2,
                                    dropout=0.2), name="bidir_rnn_1")(bn_cnn)
    ...
    bidir_rnn_2 = Bidirectional(GRU(units,
                                    ...
                                    return_sequences=True,
                                    implementation=2,
                                    dropout=0.5), name='bidir_rnn_2')(bn_rnn_1)
